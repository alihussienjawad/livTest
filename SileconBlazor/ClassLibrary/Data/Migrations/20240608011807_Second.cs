        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DowinloadResource = table.Column<int>(type: "int", nullable: false),
                    ImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoursDec = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Aritc = table.Column<int>(type: "int", nullable: false),
                    iDowinload = table.Column<int>(type: "int", nullable: false),
                    Time = table.Column<bool>(type: "bit", nullable: false),
                    Certifacate = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedItems", x => new { x.ApplicationUserId, x.CourseId });
                    table.ForeignKey(
